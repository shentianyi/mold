/**
 * Created by ���� on 2015/8/13 0013.
 */
function MouldDetail() {
    var MouldDetail = document.getElementById("MouldDetail");
    //鼠标移入
    MouldDetail.onmouseover = function () {
        MouldDetail.style.backgroundColor = '#4F94CD';
    }
    //鼠标移出
    MouldDetail.onmouseout = function () {
        MouldDetail.style.backgroundColor = '#424A5D';
    }
}

function ChgKnifeRec() {
    ...
    ChgKnifeRec.onmouseout = function () {
        ChgKnifeRec.style.backgroundColor = '#424A5D';
    }
}


function ChgKnifeSlice() {
    ...
    ChgKnifeSlice.onmouseout = function () {
        ChgKnifeSlice.style.backgroundColor = '#424A5D';
    }
}
...
function MouldMaint() {
    ...
    MouldMaint.onmouseout = function () {
        MouldMaint.style.backgroundColor = '#424A5D';
    }
}


function MouldRepair() {
    ...
    MouldRepair.onmouseout = function () {
        MouldRepair.style.backgroundColor = '#424A5D';
    }
}
...
function GNRTReport() {
    ...
    GNRTReport.onmouseout = function () {
        GNRTReport.style.backgroundColor = '#424A5D';
    }
}